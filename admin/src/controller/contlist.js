...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,url: 'http://localhost:3000/getDemo' //模拟接口 ./json/content/list.js
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: '_id', width: 300, title: '文章ID', sort: true}
			,{field: 'sort',width: 100, title: '顺序'}
      ,{field: 'title', title: '文章标题', minWidth: 100}
      ,{field: 'sub_title', title: '文章副标题'}
      ,{field: 'skill', title: '技术点'}
        ...
        ,success: function(layero, index){
          view(this.id).render('app/content/listform', data).done(function(){
            ...
            form.on('submit(layuiadmin-app-form-submit)', function(data){
              ...
              $.ajax({
								url:'http://localhost:3000/updateDemo',
								method:'post',
								data:field,
